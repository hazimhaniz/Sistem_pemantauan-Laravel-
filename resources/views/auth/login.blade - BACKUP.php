...
<div class="row">
    <div class="col-md-6">
        ...
        <form method="POST" action="{{ route('login') }}" class="p-t-15" id="form-login" name="form-login" role="form">
            ...
            <div class="row">
                <div class="col-md-12">
                    @include('components.input', [
                        'label' => 'ID Pengguna',
                        'info' => 'Bagi WARGANEGARA MALAYSIA masukkan NO MYKAD jika tidak masukkan NO PASSPORT',
                        'mode' => 'required',
                        'name' => 'username'
                    ])
                </div>
            ...
            <a class="btn btn-complete m-t-10" style="background-color: #5ec0cb !important;" href="{{ route('register') }}">Pengguna Baru</a>

            <!-- <a class="btn btn-danger m-t-10" style="color:white" onclick="mobil()"><i class="fa fa-mobile fa-2x m-r-5"></i> <span style="vertical-align: normal">Aplikasi Mobil</span> </a></br> -->
    ...
    <div id="div-announcement" class="col-md-6">
        ...
        <div class="modal fade show" id="modal-mobile" role="dialog" style="display: none;">
            <div class="modal-dialog ">
                <div class="modal-content-wrapper" style="width:360px">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i class="pg-close fs-14"></i>
                            </button>
                            <h5>Video <span class="semi-bold">Aplikasi Mobil</span></h5>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="iphone-x">
                                        <div id="speaker"></div>
                                        <div id="camera"></div>
                                        <iframe width="303" height="660" src="https://xd.adobe.com/embed/f8daa2d7-b16e-4979-74b9-6c7864c095ab-8eeb/?hints=off" frameborder="0" allowfullscreen></iframe>
                                    </div>
                                </div>
                            </div>
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <button type="button" class="btn btn-block m-t-5" style="background-color: #007bff;color: white" onclick="clickToInsertValue('admin','password')">Admin</button>
                            ...
                            <button type="button" class="btn btn-block m-t-5" style="background-color: #5A5B5B;color: white" onclick="clickToInsertValue('pluar','password')">Outsider</button>
                            ...
                            <button type="button" class="btn btn-block m-t-5" style="background-color: #28a745;color: white" onclick="clickToInsertValue('dnegara','password')">Pengguna Warganegara Malaysia</button>
                            <button type="button" class="btn btn-block m-t-5" style="background-color: #28a745;color: white" onclick="clickToInsertValue('lnegara','password')">Pengguna Warganegara Asing</button>
                        </div>
                    </div>
                </div>
            </div>

        ...
        <form method="POST">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-action="{{ route('admin.letter.update', $letter->id) }}" onClick="btnUpdate(this)">Kemaskini</button>
                </div>
            </div>
        </form>
    </div>

                ...
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Pengurusan Flow</h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan Flow boleh dilakukan melalui jadual di bawah.
                            </p>
                            <form class="p-t-10" id="form-project" role="form" autocomplete="off" method="post" action="{{ route('admin.flow') }}" novalidate>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
                 <form id='form-add' role="form" method="post" action="{{ route('admin.flow') }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default form-group-default-custom form-group-default-select2 required">
                                ...
                                <label>
                                    <span id="module_name" style="font-size:14px"></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default form-group-default-custom form-group-default-select2 required">
                                ...
                                <select id="cur_role_insert" name="cur_role" class="full-width autoscroll state" data-init-plugin="select2">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default form-group-default-custom form-group-default-select2 required">
                                ...
                                <select id="case_type_insert" name="case_type" class="full-width autoscroll state" data-init-plugin="select2">
                                    <option value="" selected="" disabled="">Pilih.</option>
...
var settings = {
    ...
    "columns": [
        ...
        { data: "cur_role", name: "cur_role", "width": "5%", defaultContent: "-", render: function(data, type, row){
            return $("<div/>").html(data).text();
        }},
        { data: "case", name: "case", "width": "75%", defaultContent: "-", render: function(data, type, row){
            return $("<div/>").html(data).text();
        }},

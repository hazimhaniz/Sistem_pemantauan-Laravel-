...
<div class="jumbotron" data-pages="parallax">
    <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            <!-- START BREADCRUMB -->
            {{ Breadcrumbs::render('admin.master.province-office') }}
            <!-- END BREADCRUMB -->
            <div class="row">
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Data Induk - Pejabat Wilayah</h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan data induk (kawasan) boleh dilakukan melalui jadual di bawah.
    ...
    <div class="card card-transparent">
        <div class="card-header px-0 search-on-button">
            <!-- <div class="card-title">
                <button onclick="add()" class="btn btn-success btn-cons"><i class="fa fa-plus m-r-5"></i> Pejabat</button>
            </div> -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle">Tambah <span class="bold">Pejabat Wilayah</span></h5>
            ...
            <div class="modal-body m-t-20">
                <form id='form-add' role="form" method="post" action="{{ route('admin.master.province-office') }}">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-default form-group-default-custom form-group-default-select2">
                                    ...
                                    <select id="state_id" name="state_id" class="full-width autoscroll" data-init-plugin="select2" required="">
                            ...
                            <div class="col-md-4">
                                <div class="form-group form-group-default form-group-default-custom form-group-default-select2">
                                    ...
                                    <select id="district_id" name="district_id" class="full-width autoscroll" data-init-plugin="select2" required="">
                                        <option value="" selected="" disabled="">Pilih satu..</option>
...
var settings = {
    ...
    "buttons": [
        /*{
            text: '<i class="fa fa-plus m-r-5"></i> Pejabat Wilayah',
...
function edit(id) {
    $("#modal-div").load("{{ route('admin.master.province-office') }}/"+id);
}
...
function remove(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('admin.master.province-office') }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,

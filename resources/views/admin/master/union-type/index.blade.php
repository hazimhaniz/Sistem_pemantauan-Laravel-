...
<div class="jumbotron" data-pages="parallax">
    <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            <!-- START BREADCRUMB -->
            {{ Breadcrumbs::render('admin.master.union-type') }}
            <!-- END BREADCRUMB -->
            <div class="row">
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Data Induk - Jenis Kesatuan</h3>
                            <p class="small hint-text m-t-5">
                                Pengurusan data induk (jenis kesatuan) boleh dilakukan melalui jadual di bawah.
    ...
    <div class="card card-transparent">
        <div class="card-header px-0 search-on-button">
            <!-- <div class="card-title">
                <button onclick="add()" class="btn btn-success btn-cons"><i class="fa fa-plus m-r-5"></i> Jenis Kesatuan</button>
            </div> -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle">Tambah <span class="bold">Jenis Kesatuan</span></h5>
            ...
            <div class="modal-body m-t-20">
                <form id='form-add' role="form" method="post" action="{{ route('admin.master.union-type') }}">
                    @include('components.input', [
                        'name' => 'name',
                        'label' => 'Nama Jenis Kesatuan',
                        'mode' => 'required',
                        'value' => ''
                    ])
                </form>
...
var settings = {
    ...
    "buttons": [
        {
            text: '<i class="fa fa-plus m-r-5"></i> Jenis Kesatuan',
...
function edit(id) {
    $("#modal-div").load("{{ route('admin.master.union-type') }}/"+id);
}
...
function remove(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('admin.master.union-type') }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,

    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle">Kemaskini <span class="bold">Mahkamah</span></h5>
            ...
            <div class="modal-body m-t-20">
                <form id='form-edit' role="form" method="post" action="{{ route('admin.master.court.form', $court->id) }}">
                    ...
                    <div class="form-group-attached m-b-10">
                        @include('components.input', [
                            ...
                            'label' => 'Alamat 1',
                            'mode' => 'required',
                            'value' => $court->address->address1
                        ])

                        @include('components.input', [
                            'name' => 'address2',
                            'label' => 'Alamat 2',
                            'value' => $court->address->address2
                        ])

                        @include('components.input', [
                            'name' => 'address3',
                            'label' => 'Alamat 3',
                            'value' => $court->address->address3
                        ])
                                ...
                                <div class="form-group form-group-default form-group-default-custom form-group-default-select2">
                                    ...
                                    <select id="edit_state_id" name="state_id" class="full-width autoscroll" data-init-plugin="select2" required="">
                                        ...
                                        <option value="{{ $state->id }}"
                                            @if($state->id == $court->address->state_id)
                                                selected
                                            @endif
                                            >{{ $state->name }}</option>
                                        @endforeach
                                ...
                                <div class="form-group form-group-default form-group-default-custom form-group-default-select2">
                                    ...
                                    <select id="edit_district_id" name="district_id" class="full-width autoscroll" data-init-plugin="select2" required="">
                                        ...
                                        <option value="{{ $district->id }}"
                                            @if($district->id == $court->address->district_id)
                                                selected
                                            @endif

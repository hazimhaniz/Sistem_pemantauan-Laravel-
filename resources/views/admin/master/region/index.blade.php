...
<div class="jumbotron" data-pages="parallax">
    <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
        <div class="inner">
            <!-- START BREADCRUMB -->
            {{ Breadcrumbs::render('admin.master.region') }}
            <!-- END BREADCRUMB -->
            <div class="row">
                <div class="col-xl-12 col-lg-12 ">
                    ...
                    <div class="card card-transparent">
                        <div class="card-block p-t-0">
                            <h3 class='m-t-0'>Data Induk - Kawasan</h3>
    ...
    <div class="card card-transparent">
        <div class="card-header px-0 search-on-button">
            <!-- <div class="card-title">
                <button onclick="add()" class="btn btn-success btn-cons"><i class="fa fa-plus m-r-5"></i> Kawasan</button>
            </div> -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle">Tambah <span class="bold">Kawasan</span></h5>
            ...
            <div class="modal-body m-t-20">
                <form id='form-add' role="form" method="post" action="{{ route('admin.master.region') }}">
...
var settings = {
    ...
    "buttons": [
        {
            text: '<i class="fa fa-plus m-r-5"></i> Kawasan',
...
function edit(id) {
    $("#modal-div").load("{{ route('admin.master.region') }}/"+id);
}
...
function remove(id) {
    ...
    .then((confirm) => {
        if (confirm) {
            $.ajax({
                url: '{{ route('admin.master.region') }}/'+id,
                method: 'delete',
                dataType: 'json',
                async: true,
                contentType: false,

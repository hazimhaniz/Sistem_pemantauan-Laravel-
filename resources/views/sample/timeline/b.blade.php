<div class="notification-panel no-border">
	<div class="notification-body">
		...
		@component('components.timeline.item', [
			'title' => 'Permohonan Pendaftaran KS',
			'date' => '19 Januari 2018'
		])
			@component('components.timeline.content', ['title' => 'Lampiran'])
				<ul>
					<li><a class="btn btn-default btn-xs" href="#"><i class="mr-1 fa fa-external-link"></i> Borang B2</a></li>
					<li><a class="btn btn-default btn-xs" href="#"><i class="mr-1 fa fa-external-link"></i> Borang B3</a></li>

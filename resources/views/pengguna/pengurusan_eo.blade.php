...
.sweet-alert {
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalTitle"><span class="bold">Pendaftaran Environmental Officer (EO) 2</span></h5>
    ...
    <div class="modal fade" id="modal-view" tabindex="-1" role="dialog" aria-labelledby="addModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalTitle"><span class="bold">Maklumat Environmental Officer (EO) 3</span></h5>
                    <!-- <small class="text-muted m-b-20">Sila isi ruangan di bawah bagi pendaftaran baharu environmental officer.</small> -->
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>

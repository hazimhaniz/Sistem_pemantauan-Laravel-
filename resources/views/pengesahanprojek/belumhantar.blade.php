        ...
        <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Projek Yang Belum Dihantar</li>
                </ol>
                <div class="row">
                    <div class="col-xl-12 col-lg-12 ">
                        <div class="card card-transparent">
                            <div class="card-block p-t-0">
                                <h3 class='m-t-0'>Projek Yang Belum Dihantar</h3>
                                <!-- <p class="hint-text m-t-5">Senarai pendaftaran projek yang belum dilaksanakan dan belum dihantar oleh Penggerak Projek.</p> -->
            ...
            <div class="card-header px-0">
                <!-- <div class="row"> -->
                    ...
                    <div class="col-md-3 pull-right">
                        <input type="text" id="search-table" class="form-control" placeholder="Carian...">
                    </div>
                <!-- </div> -->
            ...
            <div class="card-block">
                <table class="table table-hover" style="width: 100%" id="table" border="1px">
                    ...
                    <tr>
                        ...
                        <td>05/03/2019</td>
                        <td><span class="badge badge-danger">Belum Dihantar</span></td>
                        <td>

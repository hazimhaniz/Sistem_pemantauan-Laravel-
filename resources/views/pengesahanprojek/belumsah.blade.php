        ...
        <div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
            <div class="inner">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Projek Yang Belum Disahkan</li>
                </ol>
                <div class="row">
                    <div class="col-xl-12 col-lg-12 ">
                        <div class="card card-transparent">
                            <div class="card-block p-t-0">
                                <h3 class='m-t-0'>Projek Yang Belum Disahkan</h3>
                                <!-- <p class="hint-text m-t-5">Senarai pendaftaran projek yang telah dilaksanakan oleh Penggerak Projek dan belum disahkan.</p> -->

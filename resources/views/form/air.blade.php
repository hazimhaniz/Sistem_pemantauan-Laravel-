    <form id="air" action="{{route('form.borangDKawasanLarianAirPermukaan')}}" method="POST">
        <div class="row">
            ...
            <div class="col-md-12 p-t-20" style="padding-bottom: 15px;">
                <ul class="pager wizard no-style">
                    ...
                    <li class="submit">
                        <button class="btn btn-info btn-cons from-left pull-right" onclick="submitAir('air')" type="button">
                            <span>Simpan</span>
                        </button>
                    </li>
                    @endif
            ...
            <div class="col-md-12">
             ...
             <table class="" id="table" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
                ...
                <tbody>
                    <tr>
                        <td bgcolor="#EFD9DB" rowspan="5">TUMPUAN ALIRAN AIR LARIAN PERMUKAAN (CONCENTRATED FLOW IN DRAINAGE WAY)</td>
                        <td bgcolor="#f0f0f0" >TERDAPAT SISTEM PERPARITAN. </td>
                        <td bgcolor="#f0f0f0">
                ...
                <tr>
                    <td bgcolor="#f0f0f0">SISTEM PERPARITAN BERSAMBUNG DENGAN SEMPURNA</td>
                    <td bgcolor="#f0f0f0">
                        <textarea class="form-control border border-default rounded" name="ulasan[]" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea>
                    </td>
                    <td bgcolor="#f0f0f0" class="align-center text-center"> 
            ...
            <tr>
                <td bgcolor="#f0f0f0">SISTEM PERPARITAN BERSAMBUNG DENGAN SEMPURNA KE PERANGKAP SEDIMEN/KOLAM PERANGKAP SEDIMEN</td>
                <td bgcolor="#f0f0f0">
                    <textarea class="form-control border border-default rounded" name="ulasan[]" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea>
                </td>
                <td bgcolor="#f0f0f0" class="align-center text-center">      
        ...
        <tr>
            <td bgcolor="#f0f0f0">TERDAPAT SISTEM PERPARITAN UNTUK MENGAWAL AIR LARIAN PERMUKAAN DARI LUAR MASUK KE KAWASAN TAPAK PROJEK.</td>
            <td bgcolor="#f0f0f0">
                <textarea class="form-control border border-default rounded" name="ulasan[]" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea>
            </td>
            <td bgcolor="#f0f0f0" class="align-center text-center"> 
    ...
    <tr>
        <td bgcolor="#f0f0f0">TERDAPAT PELEPASAN DARI TAPAK MELALUI KOLAM SEDIMEN</td>
        <td bgcolor="#f0f0f0">
            <textarea class="form-control border border-default rounded" name="ulasan[]" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea>
        </td>
        <td bgcolor="#f0f0f0" class="align-center text-center">
...
<script type="text/javascript">
    ...
    function submitAir(form_id) {
        ...
        Swal.fire({
            ...
            if(result.value){
                $.ajax({
                    url: "{{ route('form.borangDKawasanLarianAirPermukaan') }}",
                    method: "POST",

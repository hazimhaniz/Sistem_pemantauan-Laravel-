                    ...
                    <div class="col-md-12">
                        <div class="form-group-attached m-b-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        @foreach($decodelaporankimia as $laporankimia)
                                            @if((pathinfo(asset('/storage/uploads/' . $laporankimia))["extension"])!= "pdf")
                                ...
                                @endif
                                <div class="col-md-6">
                                    <input type="hidden" id="gambar_count_sungai" name="gambar_count_sungai" value="1">
                                    <div class="form-group form-group-default" >
                                        <label><span><b class="text-dark">GAMBAR PERSAMPELAN</b></span></label>
                                        ...
                                        <button type="button" class="btn btn-info btn-xs" onclick="addGambarsungai()" style="font-size: 12.5px;">+</button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="laporan_count_sungai" name="laporan_count_sungai" value="1">

                                    <div class="form-group form-group-default" id="addLaporansungai">
                                        <label><span><b class="text-dark">LAPORAN KIMIA</b></span></label>
                                        <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file" >
                                        <button type="button" class="btn btn-info btn-xs" onclick="addLaporansungai()" style="font-size: 12.5px;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <tbody>
                                @if(empty($monthlyC))
                                    ...
                                    <tr>                                        
                                        ...
                                        <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps[]" id="{{ $parameter->parameter_id }}" onkeypress="return verifyKey(event)" autocomplete="off" /></td>
                                    </tr>
                                    @endforeach
                                @else
                                ...
                                <input type="hidden" name="borangc_id" id="borangc_id" value="{{$monthlyC->monthly_c_id ?? '-' }}" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <table class="table table-responsive" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%;max-height:300px;">
                            <thead>
                                <tr>
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:5%;">INDEKS SUNGAI</th>
...
@include('form.sungai.js.borang-c-create')
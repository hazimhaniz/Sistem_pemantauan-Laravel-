                    ...
                    <table class="table table-responsive" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%;max-height:300px;">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:15%;">Baseline EIA</th>
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:15%;">Baseline EMP</th>
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:15%;">Bacaan Cerap</th>
                                </tr>
                            </thead>
                            <tbody>
                                @if(empty($monthlyC))
                                ...
                                <tr>
                                    ...
                                    <td>{{ $parameter->baselineemp ?? '-'}}</td>
                                     @if ($monthlyC->monthlyC->bacaanCerap)
                                        ...
                                        @endforeach
                                    @else
                                    <td class="align-middle text-center"><input readonly class="form-control" name="bacaan_ceraps[]" id="{ { $parameter->id }}" autocomplete="off" /></td>
                                    @endif
                                </tr>
                                @endforeach
                                @endif

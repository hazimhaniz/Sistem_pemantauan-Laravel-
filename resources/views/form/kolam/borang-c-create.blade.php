    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <button type="button" class="close" data-d ismiss="modal" aria-label="Close">
                    ...
                    <div class="col-md-12">
                        <div class="form-group-attached m-b-12">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <input type="hidden" id="gambar_count_kolam" name="gambar_count_kolam" value="1">
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">GAMBAR PERSAMPELAN</b></span></label>
                                        <div class="" id="addGambar">
                                            ...
                                            <button type="button" class="btn btn-info btn-xs" onclick="addGambarkolam()" style="font-size: 12.5px;">+</button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="laporan_count_kolam" name="laporan_count_kolam" value="1">

                                    <div class="form-group form-group-default" id="addLaporankolam">
                                        <label><span><b class="text-dark">LAPORAN KIMIA</b></span></label>
                                        <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file">
                                            <button type="button" class="btn btn-info btn-xs" onclick="addLaporankolam()" style="font-size: 12.5px;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>

    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
                <div class="row">
                    <div class="col-md-12">
                        <label style="font-size:12px">ADAKAH PEMANTAUAN DIBUAT <i style="cursor: help; color: #48B0F7;" class="fa fa-question-circle info_ " data-html="true" data-toggle="tooltip" title="" data-original-title=""></i></label>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        <div class="form-group-attached m-b-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">GAMBAR LOKASI PEMANTAUAN</b></span></label>
                                        <?php
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">LAPORAN ANALISIS UDARA</b></span></label>
                                        <?php
                                ...
                                @endif
                                <div class="col-md-6">
                                    <input type="hidden" id="gambar_count_udara" name="gambar_count_udara" value="1">
                                    <div class="form-group form-group-default">
                                        ...
                                        <div class="" id="addGambar">
                                            ...
                                            <button type="button" class="btn btn-info btn-xs" onclick="addGambarudara()" style="font-size: 12.5px;">+</button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="laporan_count_udara" name="laporan_count_udara" value="1">

                                    <div class="form-group form-group-default" id="addLaporanudara">
                                        ...
                                        <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file">
                                            <button type="button" class="btn btn-info btn-xs" onclick="addLaporanudara()" style="font-size: 12.5px;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
@include('form.udara.js.borang-c-create')
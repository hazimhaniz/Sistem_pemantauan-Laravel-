<div class="modal fade" id="baseAjaxModalContent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="addModalTitle"> Tambah <b>STESEN UDARA</b></h5>
                @else
                <h5 class="modal-title" id="addModalTitle"> Kemaskini <b>STESEN UDARA</b></h5>
                @endif
            ...
            <div class="modal-body m-t-20">
                ...
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select id="class" name="class" class="select-normal full-width" style="border: none">
                                                    ...
                                                    <option value="IT-2 (2018)" {{ $pengawasanUdara->class == 'IT-2' ? 'selected':'' }}>Udara Kelas IT 2 (2018</option>
                                                    <option value="Standard (2020)" {{ $pengawasanUdara->class == 'Standard' ? 'selected':'' }}>Udara Kelas Standard (2020)</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group required form-group-default">
                                    ...
                                    <input id="stesen" value="{{ $pengawasanUdara->stesen }}" name="stesen" class="form-control form-control-lg" type="text" autocomplete="off" />
                                </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="checkbox check-primary">
                                            <input type="checkbox" class="form-check-input" id="udara_is_eia" onclick="displayDateEIA()"  checked />
                                            <label class="form-check-label" for="udara_is_eia"><font color="red">*</font> Peringkat EIA</label>
                                            @if($pengawasanUdara->is_emp)
                                            <input type="checkbox" class="form-check-input" id="udara_is_emp" onclick="displayDateEMP()" checked/>
                                            <label class="form-check-label" for="udara_is_emp">Peringkat EMP</label>
                                            @else
                                            <input type="checkbox" class="form-check-input" id="udara_is_emp" onclick="displayDateEMP()"/>
                                            <label class="form-check-label" for="udara_is_emp">Peringkat EMP</label>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default input-group" id="show_date_eia" style="display: block;">
                                            <div class="form-input-group">
                                                ...
                                                <input class="form-control datepicker auditData" data-date-end-date="0d" id="udara_date_eia" name="udara_date_eia" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanUdara->date_eia)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12" id="show_date_emp" hidden>
                                            ...
                                            <div class="form-group form-group-default input-group" style="display: block;">
                                                <div class="form-input-group">
                                                    ...
                                                    <input class="form-control datepicker auditData" data-date-end-date="0d" id="udara_date_emp" name="udara_date_emp" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanUdara->date_emp)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12" style="overflow:auto; max-height:300px;">
                                    ...
                                    <table class="table" id="parameterStesenUdaraTable" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                                        <thead>
                                            <tr role="row">
                                                ...
                                                <th bgcolor="#" class="align-top text-center" style=" vertical-align:top; color:#;display: none;" id="baseline_emp_udara">DATA BASELINE (EMP)</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @if(empty($pengawasanUdara->stesen))
                                            <td colspan="5"><b>Sila Pilih Standard<font color="red">*</font></b></td>
                                            @else
                                            <?php $i=1; ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center"><input class="form-control" name="parameters[]" id="{{ $parameter->parameter }}" onkeypress="return verifyKey(event)" autocomplete="off" value="{{ $parameter->baselineeia }}" /></td>
                                                 <td class="align-middle text-center"><input class="form-control base_emp_udara" name="base_emp[]" id="base{{ $parameter->parameter }}" onkeypress="return verifyKey(event)" autocomplete="off" value="{{ $parameter->baselineeia }}" /></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
                                ...
                                <div class="col-md-12" style="overflow:auto; max-height:300px; margin-top: 20px;">
                                    <br />
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">GAMBAR STESEN UDARA</b></span></label>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="dashTitle"><span style="color:red;">*</span><b>Rujukan Kualiti Udara Ambien Malaysia</b></div>
                            <br>
                            <table class="" id="table" role="grid" aria-describedby="table_info" border="1px" style="padding:10px;">
                                <thead>
                                    <tr role="row">
                                        <th bgcolor="#" class="align-top text-center" style="width:2%; vertical-align:top; color:#">Standard</th>
                    ...
                    <div class="modal-footer">
                        @if(!$pengawasanUdara->stesen)
                        <button type="button" data-action="{{ route('project.tambah.stesen.udara', $projek) }}" onclick="btnTambahStesenUdara(this)" class="btn btn-success">Simpan</button>
                        @else
                        <button type="button" data-action="{{ route('project.update.stesen.udara', $pengawasanUdara) }}" onclick="btnUpdateStesenUdara(this)" class="btn btn-success">Kemaskini</button>
                        @endif
                    </div>
                </div>
            </div>
    ...
    function intialdisplay() {
        var show_date_emp = document.getElementById("show_date_emp");
         var udara_is_emp = document.getElementById("udara_is_emp");
        if (udara_is_emp.checked) {
            document.getElementById("baseline_emp_udara").style.display = "block";
            $('.base_emp_udara').show();
        } else {
            document.getElementById("baseline_emp_udara").style.display = "none";
            $('.base_emp_udara').hide();
        }
    }

<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 6
    };

    $('#stesenUdaraDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.udara.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.udara.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.udara.modal', 'data-id') }}`;
    ...
    $('#stesenUdaraBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('form.udara.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.udara.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.udara.borang-c-create', 'data-id') }}`;

<form id="formDHakisan_{{ $elemen_id }}" method="POST" action="{{ url('/projek/submit-form-d') }}">
    @csrf
                    ...
                    <tr>
                        ...
                        <td bgcolor="#f0f0f0">
                            ...
                            <div tabindex="500">
                                ...
                                <div id="downloadFile_{{ $elemen_id }}_{{ $MasterBMP->id }}" class="downloadFileDivHakisan">
    ...
    <div class="col-md-12 p-t-20" style="padding-bottom: 15px;">
        <input type="hidden" name="flag" id="flagD3" value="">
        <ul class="pager wizard no-style">
            @if($borangD)
            @hasanyrole('eo')
            @if($borangD->status_id == 600)
            <li class="submit">
                <button onclick="submitFormDHakisan_{{ $elemen_id }}()" class="btn btn-info btn-cons from-left pull-right" name="submit" value="Simpan" type="button">
                    <span>Simpan</span>
                </button>
            </li>
            @endif
...
<script>
    function submitFormDHakisan_{{ $elemen_id }}()
    {
        var form = $("#formDHakisan_{{ $elemen_id }}");

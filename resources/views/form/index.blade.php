            ...
            <div class="col-md-12">
                <div class="card card-transparent">
                    <div class="card-block">
                        <h3 style="font-family:'Montserrat'; font-size:14.5px">No. Fail JAS:</b> {{$projek->no_fail_jas}}</h3>

                        <div class="dashTitle">Nama Fail JAS: <b>{{$projek->nama_projek}} </b></div>
...
<div class=" container-fluid container-fixed-lg">
    <!-- START card -->       
    @include('form.form',['proejk' => $projek , 'jenispengawasan' => $jenis, 'logdata' => $logdata])
</div>

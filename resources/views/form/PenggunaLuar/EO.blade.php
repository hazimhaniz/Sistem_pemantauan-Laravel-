...
<!-- START CONTAINER FLUID -->
    ...
    <!-- <div class="card card-transparent"> -->
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-top text-center"> SEIA REPORT FOR THE PROPOSED LANE WIDENING BETWEEN EBOR AND
                                    ...
                                    <td class="align-top text-center">AMZARI</td>
                                    <td class="align-top text-center">EO</td>
                            ...
                            <tr>
                                ...
                                <td class="align-top text-center"> SEIA REPORT FOR THE PROPOSED LANE WIDENING BETWEEN EBOR AND
                                    USJ AT NORTH-SOUTH EXPRESSWAY CENTRAL LINK (ELITE)</td>
                                    <td class="align-top text-center">AMIRUL</td>
                                    <td class="align-top text-center">EO</td>
                                <td class="align-top text-center"><span
                                        style="text-align:center;font-size:16px; "
        ...
        <!-- Modal Ahli Projek -->
        <div class="modal fade" id="eo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
			aria-hidden="true">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        ...
                                        <input id="" class="form-control datepicker " name="" placeholder="" required="" type=""
                                            value="">
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="input-group file-caption-main">
                                    ...
                                    <div class="input-group-btn input-group-append">
                                        ...
                                        <div tabindex="500" class="btn btn-primary btn-file"><i class="fa fa-folder-open"></i> <span
                                                class="hidden-xs">Muat Naik..</span><input id="input-ke-salinan"

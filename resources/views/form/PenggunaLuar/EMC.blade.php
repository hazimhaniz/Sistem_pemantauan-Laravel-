...
@section('content')
    ...
    <div class=" container-fluid container-fixed-lg bg-white m-t-20">
        ...
        <h5><span><b class="text-dark">PENGURUSAN PENGGUNA LUAR EMC</b></span></h5>
        <br>
        <div class="row">
            <div class="col-md-2">
                        ...
                        <tr>
                            ...
                            <td class="align-top text-center">
                                <button type="button" class="dt-button buttons-html5 btn btn-default btn-xs m-t-5"
                                    data-toggle="modal" data-target="#emc">
                                    TINDAKAN
                                </button>
    ...
    <!-- Modal Ahli Projek -->
    <div class="modal fade" id="emc" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group form-group-default">
                                    ...
                                    <input class="form-control form-control-lg" name="alamat_tapak_1" type="text"
                                        placeholder="">
                                </div>
                            ...
                            <div class="input-group file-caption-main">
                                ...
                                <div class="input-group-btn input-group-append">
                                    ...
                                    <div tabindex="500" class="btn btn-primary btn-file"><i class="fa fa-folder-open"></i>
                                        <span class="hidden-xs">Muat Naik..</span><input id="input-ke-salinan"
                                            name="input-ke-salinan[]" type="file" multiple=""></div>
                                </div>
                            </div>
                            ...
                            <table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:5px;">
                                ...
                                -->
                                    <thead>
                                        <tr>
                                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:2%; vertical-align:top; color:#fff">Kod Makmal</th>
                                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:2%; vertical-align:top; color:#fff">Nama Makmal Akreditasi</th>
                                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:2%; vertical-align:top; color:#fff">No Tel Makmal Akreditasi</th>
                                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:2%; vertical-align:top; color:#fff">Alamat</th>
                                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:2%; vertical-align:top; color:#fff">Skop Pengawasan</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="align-top text-center">MAKMAL SUNGAI</td>
                                            <td class="align-top text-center">012665779></td>
                                            <td class="align-top text-center">LOT D-6-8</td>

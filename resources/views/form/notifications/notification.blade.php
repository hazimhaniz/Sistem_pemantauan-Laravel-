				...
				<table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
					<thead>
						<tr role="row">
							...
							<th bgcolor="#206575" class="align-top text-center"
								style="width:15%; vertical-align:top; color:#fff">Kod Notifikasi</th>
							<th bgcolor="#206575" class="align-top text-center"
								style="width:10%; vertical-align:top; color:#fff">Nama Notifikasi</th>
							<th bgcolor="#206575" class="align-top text-center"
								style="width:30%; vertical-align:top; color:#fff">Status</th>
							<th bgcolor="#206575" class="align-top text-center"
					...
					<tbody>
						<tr>
							...
							<td class="align-top text-center">Pengesahan Projek</td>

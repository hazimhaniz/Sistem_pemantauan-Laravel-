<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 3
    };

    $('#stesenTasikDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                let viewUrl = `{{ route('project.view.stesen.tasik.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.tasik.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.tasik.modal', 'data-id') }}`;
    ...
    $('#stesenTasikBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "data": 'id',
            "render": function(id, type, full, meta) {
                let viewUrl = `{{ route('form.tasik.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.tasik.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.tasik.borang-c-create', 'data-id') }}`;

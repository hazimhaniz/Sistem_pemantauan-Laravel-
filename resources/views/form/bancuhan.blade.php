    <form id="bancuhan" action="{{route('form.bancuhan')}}" method="POST">
        <div class="row">
            @csrf
            <div class="col-md-12 p-t-20" style="padding-bottom: 15px;">
                <ul class="pager wizard no-style">
                    ...
                    <li class="submit">
                        <button class="btn btn-info btn-cons from-left pull-right" onclick="submitBancuhan('bancuhan')" type="button">
                            <span>Simpan</span>
                        </button>
                    </li>
                    @endif
            ...
            <table class="" id="table" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
                ...
                <tbody>
                    <tr>
                        <td bgcolor="#EFD9DB">SISA KONKRIT</td>
                        <td bgcolor="#f0f0f0" >SISA KONKRIT DITAKUNG
                        </td>
                        <td bgcolor="#f0f0f0"><textarea class="form-control border border-default rounded" name="sisa_konkrit_ditakung" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea></td>
                ...
                <tr>
                    <td bgcolor="#EFD9DB">EFLUEN</td>
                    <td bgcolor="#f0f0f0">EFLUEN DINEUTRALKAN DENGAN ASID</td>
                    <td bgcolor="#f0f0f0"><textarea class="form-control border border-default rounded" name="efluen_dineutralkan_dengan_asid" id="name" style="height: 35px;" placeholder="Expandable area" aria-invalid="false"></textarea></td>
                    <td bgcolor="#f0f0f0" class="align-center text-center"> 
                      <div tabindex="500" class="btn btn-default">
                        <input type="file" name="files[]" multiple>
                    </div>
...
<script type="text/javascript">
    ...
    function submitBancuhan(form_id) {

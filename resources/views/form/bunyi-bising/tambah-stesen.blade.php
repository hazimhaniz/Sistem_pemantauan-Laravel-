    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="addModalTitle"> Tambah <b>STESEN BUNYI BISING</b></h5>
                @else
                <h5 class="modal-title" id="addModalTitle"> Kemaskini <b>STESEN BUNYI BISING</b></h5>
                @endif
            ...
            <div class="modal-body m-t-20">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group-attached m-b-10">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select id="jadual" name="jadual" class="select-normal full-width" style="border: none">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group form-group-default">
                                                ...
                                                <select id="class" name="class" class="select-normal full-width" style="border: none">
                                                    <option selected disabled>Sila Pilih Class</option>
                                    ...
                                    <div class="form-group required form-group-default">
                                        ...
                                        <input id="stesen" value="{{ $pengawasanBunyiBising->stesen }}" name="stesen" class="form-control form-control-lg" type="text" autocomplete="off" />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="checkbox check-primary">
                                            <input type="checkbox" class="form-check-input" id="bunyibising_is_eia" onclick="displayDateEIA()" checked />
                                            <label class="form-check-label" for="bunyibising_is_eia">
                                                <font color="red">*</font> Peringkat EIA
                                            </label>
                                            @if($pengawasanBunyiBising->is_emp)
                                            <input type="checkbox" class="form-check-input" id="bunyibising_is_emp" onclick="displayDateEMP()" checked />
                                            <label class="form-check-label" for="bunyibising_is_emp">Peringkat EMP</label>
                                            @else
                                            <input type="checkbox" class="form-check-input" id="bunyibising_is_emp" onclick="displayDateEMP()" />
                                            <label class="form-check-label" for="bunyibising_is_emp">Peringkat EMP</label>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default input-group" id="show_date_eia" style="display: block;">
                                            <div class="form-input-group">
                                                ...
                                                <input class="form-control datepicker auditData" data-date-end-date="0d" id="bunyibising_date_eia" name="bunyibising_date_eia" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanBunyiBising->date_eia)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            @endif
                                                <div class="form-group form-group-default input-group" style="display: block;">
                                                    <div class="form-input-group">
                                                        ...
                                                        <input class="form-control datepicker auditData" data-date-end-date="0d" id="bunyibising_date_emp" name="bunyibising_date_emp" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanBunyiBising->date_emp)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                                    </div>
                                                </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12" style="overflow:auto; max-height:300px;"  >
                                    <div class="dashTitle eia_table">Maklumat Parameter Baseline EIA</div>
                                    <label class="eia_table">Standard merujuk kepada Environmental Noise Limits and Control</label>
                                    <table class="table eia_table" id="parameterStesenBunyiBisingTable" role="grid" aria-describedby="table_info" border="1px" style="padding:10px;max-height:300px;" >
                                        <thead>
                                        <tr role="row">
                                    ...
                                    <div class="dashTitle eim_table">Maklumat Parameter Baseline EMP</div>
                                    <label class="eim_table">Standard merujuk kepada Environmental Noise Limits and Control</label>
                                    <table class="table eim_table" id="parameterStesenBunyiBisingTable2" role="grid" aria-describedby="table_info" border="1px" style="padding:10px;max-height:300px;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center">{{ $parameter->masterParameter->unit }}</td>
                                                <td class="align-middle text-center">@if($parameter->masterStandard){{ ($parameter->masterStandard->parameter) }}@endif</td>
                                                <td class="align-middle text-center"><input class="form-control" name="base_emp[]" id="base{{ $parameter->parameter }}" onkeypress="return verifyKey(event)" autocomplete="off" value="{{ $parameter->baselineemp }}" /></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
                ...
                <div class="modal-footer">
                    @if(!$pengawasanBunyiBising->stesen)
                    <button type="button" data-action="{{ route('project.tambah.stesen.bunyi.bising', $projek) }}" onclick="btnTambahStesenBunyiBising(this)" class="btn btn-success">Simpan</button>
                    @else
                    <button type="button" data-action="{{ route('project.update.stesen.bunyi.bising', $pengawasanBunyiBising) }}" onclick="btnUpdateStesenBunyiBising(this)" class="btn btn-success">Kemaskini</button>
                    @endif
                </div>
            </div>
        </div>

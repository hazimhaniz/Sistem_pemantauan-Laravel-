                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group-default">
                                        <div class="form-input-group">
                                            ...
                                            <input disabled class="form-control form-control-lg" name="nama_fail" id="nama_fail" type="text" value="{{ $monthlyC->nama_fail ?? '' }}" placeholder="">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <table class="" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:20%;">Baseline</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @foreach($monthlyC->monthlyC->bacaanCerap as $keyCerap => $value)
                                        ...
                                        <td class="align-middle text-center"><input readonly class="form-control" name="bacaan_ceraps2[]" id="{{ $value->id }}" value="{{ $value->bacaan_cerap }}" autocomplete="off" /></td>
                                        @endif
                                    @endforeach
                                </tr>
                                @endforeach

<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 7
    };

    $('#stesenBunyiBisingDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.bunyi.bising.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.bunyi.bising.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.bunyi.bising.modal', 'data-id') }}`;
    ...
    $('#stesenBunyiBisingBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "data": 'id',
            "render": function(id, type, full, meta) {
                let viewUrl = `{{ route('form.bunyi.bising.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.bunyi.bising.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.bunyi.bising.borang-c-create', 'data-id') }}`;

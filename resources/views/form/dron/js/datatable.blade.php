<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 9
    };

    $('#stesenDronDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.dron.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.dron.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.dron.modal', 'data-id') }}`;
    ...
    $('#stesenDronBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('form.dron.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.dron.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.dron.borang-c-create', 'data-id') }}`;

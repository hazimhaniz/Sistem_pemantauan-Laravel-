...
<!-- START CONTAINER FLUID -->
                    ...
                    <table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                        <thead>
                            <tr role="row">
                                ...
                                <th bgcolor="#206575" class="align-top text-center"
                                    style="width:10%; vertical-align:top; color:#fff">MARKAH</th>
                                <th bgcolor="#206575" class="align-top text-center"
	...
	<button type="button" id="btnSave" class="btn btn-info float-save" onclick=""><i class="fa fa-check m-r-5"></i>Kuiri</button>
        ...
        <div class="modal fade" id="semakan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
			aria-hidden="true">
			<div class=" modal-dialog modal-dialog-centered modal-lg" role="document">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="addModalTitle">  <b>Status Laporan Pengawasan Mengikut Projek Bagi Bulan Januari 2020</b></h5>
					...
					<div class="modal-body m-t-20">
                        <label style="font-size:14px; font-family: 'Montserrat'"><b>No Fail JAS: </b>(B)B50/011/100/377</label>
                        <label style="font-size:14px; font-family: 'Montserrat'"><b>Nama Projek: </b>LAPORAN ENVIRONMENTAL IMPACT ASSESSMENT (EIA) FOR THE PROPOSED MIXED DEVELOPMENT (140 ACRES) ON STATE ALIENATED LAND TO PEMBINAAN JAYA MEGAH SDN BHD (MMKN SELANGOR APPROVED WITH REFERENCE NO</label>
					<div class="row">
                        <div class="col-md-12">
                            <table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                                <thead>
                                    <tr role="row">
                                        <th bgcolor="#206575" class="align-top text-center"
                                            style="width:2%; vertical-align:top; color:#fff">Laporan</th>
                                        {{-- <th bgcolor="#206575" class="align-top text-center"
                                            style="width:15%; vertical-align:top; color:#fff">Ahli Projek</th> --}}
                                        <th bgcolor="#206575" class="align-top text-center"
                                            style="width:10%; vertical-align:top; color:#fff">MAKSIMUM MARKAH (%)</th>
                                        <th bgcolor="#206575" class="align-top text-center"
                                            style="width:30%; vertical-align:top; color:#fff">JUMLAH KUIRI YANG DIREKODKAN</th>
                                        <th bgcolor="#206575" class="align-top text-center"
                                            style="width:10%; vertical-align:top; color:#fff">JUMLAH POTONGAN (%)</th>
                                        <th bgcolor="#206575" class="align-top text-center"
                                            style="width:10%; vertical-align:top; color:#fff">JUMLAH MARKAH (%)</th>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">5</td>
                                    </tr>
                                    <tr>
                                        <td class="align-top text-center">Bahagian B (EIA 2-18)</td>
                                        <td class="align-top text-center">25</td>
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">25</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="align-top text-center">30</td>
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">0</td>
                                        <td class="align-top text-center">30</td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-top text-center"><b>100</b></td>
                                        <td class="align-top text-center"></td>
                                        <td class="align-top text-center"><b>0</b></td>
                                        <td class="align-top text-center"><b>100</b></td>
                                    </tr>
                           ...
                           <div class="row">
                          <div class="col-md-6">
                            <small class="text-muted">Nota :
                                1 Kuiri = -2 Markah</small>
                          </div>
                           </div>
                        </div>
                    </div>

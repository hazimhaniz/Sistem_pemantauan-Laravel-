...
<div class=" container-fluid container-fixed-lg bg-white m-t-20">
    ...
    <div id="table_wrapper" class="dataTables_wrapper no-footer">
        <div class="dt-buttons">
            ...
            <button class="dt-button buttons-excel buttons-html5 btn btn-default btn-sm" tabindex="0" aria-controls="table" type="button" style="margin-top:3%"><span><i class="fa fa-download m-r-5"></i>
                    Excel</span></button>
            <button class="dt-button buttons-pdf buttons-html5 btn btn-default btn-sm" tabindex="0" aria-controls="table" type="button" style="margin-top:3%"><span><i class="fa fa-download m-r-5"></i>
                    PDF</span></button>
            ...
            <table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                <thead>
                    <tr role="row">
                        ...
                        <th bgcolor="#206575" class="align-top text-center" style="width:30%; vertical-align:top; color:#fff">Nama & Maklumat Projek </th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="align-top text-center">
                            <button style="margin-bottom:5px;" type="button" class="dt-button  btn btn-default btn-sm " data-toggle="modal" data-target="#laporan">
                                <i class="far fa-eye text-info"></i> Laporan Pemeriksaan Hujan&nbsp;
                            </button>
                            <br>
...
<div class="modal fade stick-up slide-right show " id="laporan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class=" modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addModalTitle"> <b>Laporan Hujan</b></h5>

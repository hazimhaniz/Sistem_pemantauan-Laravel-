                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            @endif
                            <div class="col-md-6">
                                <input type="hidden" id="gambar_count_marin" name="gambar_count_marin" value="1">
                                <div class="form-group form-group-default">
                                    <label><span><b class="text-dark">GAMBAR PERSAMPELAN</b></span></label>
                                    <div class="" id="addGambar">
                                        ...
                                        <button type="button" class="btn btn-info btn-xs" onclick="addGambarmarin()" style="font-size: 12.5px;">+</button>
                                    </div>
                            ...
                            <div class="col-md-6">
                                <input type="hidden" id="laporan_count_marin" name="laporan_count_marin" value="1">

                                <div class="form-group form-group-default" id="addLaporanmarin">
                                    <label><span><b class="text-dark">LAPORAN KIMIA</b></span></label>
                                    <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file">
                                        <button type="button" class="btn btn-info btn-xs" onclick="addLaporanmarin()" style="font-size: 12.5px;">+</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="table" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%;max-height:300px;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps[]" onkeypress="return verifyKey(event)" id="{{ $parameter->id }}" value="{{ $value->bacaan_cerap }}" autocomplete="off" /></td>
                                    @endif
                                    @else
                    ...
                    <table class="table" id="parameterStesenMarinTable2" role="grid" aria-describedby="table_info" border="1px" style="padding:10px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $parameter->baselineeia }}</td>
                                <td>{{ $parameter->baselineemp ? $parameter->baselineemp : '-' }}</td>
                                <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps2[]" id="b{{ $parameter->id }}" autocomplete="off" /></td>
                            </tr>
                            @endforeach
                            @else
                            <?php $i = 1; ?>
                            ...
                            if ($monthlyC->monthlyC->bacaanCerapB) {
                                $count = count($monthlyC->monthlyC->bacaanCerapB);
                            }
                            ?>
                            <tr>
                                <td>{{ $i++ }}</td>
                                ...
                                @if ($count > 0)
                                    ...
                                    @if($monthlyC->monthlyC->bacaanCerapB)
                                    @if($keyParam == $keyCerap)
                                    <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps2[]" id="{{ $parameter->id }}" value="{{ $value->bacaan_cerap_b }}" autocomplete="off" /></td>
                                    @endif
                                    @else
                                    ...
                                    @endforeach
                                @else
                                <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps2[]" onkeypress="return verifyKey(event)" id="{{ $parameter->id }}" autocomplete="off" /></td>
                                @endif
                            </tr>
                            @endforeach
                            @endif

<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 2
    };

    $('#stesenMarinDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.marin.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.marin.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.marin.modal', 'data-id') }}`;
    ...
    $('#stesenMarinBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "data": 'id',
            "render": function(id, type, full, meta) {
                let viewUrl = `{{ route('form.marin.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.marin.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.marin.borang-c-create', 'data-id') }}`;

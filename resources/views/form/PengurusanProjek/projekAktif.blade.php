...
<!-- <div class="card card-transparent"> -->
	<div class=" container-fluid container-fixed-lg bg-white m-t-20">
		<h5><span><b class="text-page">PENGURUSAN PROJEK</b></span></h5>
		<h5><span><b class="text-dark">PROJEK AKTIF</b></span></h5>
		<br>
		<div id="table_wrapper" class="dataTables_wrapper no-footer">
			<div class="card card-transparent">
				<table class="table" id="projekAktifTable" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
					<thead>
						<tr role="row">

...
<!-- <div class="card card-transparent"> -->
    <div class=" container-fluid container-fixed-lg bg-white m-t-20">
        <h5><span><b class="text-dark">PROJEK YANG TELAH DISAHKAN</b></span></h5>
        <br>
        <div id="table_wrapper" class="dataTables_wrapper no-footer">
            <div class="card card-transparent">
                <table class="table"id="projekTelahSahTable" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                    <thead>
                        <tr role="row">
                            ...
                            <th bgcolor="#adadad" class="align-top text-center" style="width:10%; vertical-align:top; color:#fff">TARIKH HANTAR</th>
                            <th bgcolor="#adadad" class="align-top text-center" style="width:15%; vertical-align:top; color:#fff">TARIKH SAH</th>
                        </tr>
                    </thead>
                    <tbody>

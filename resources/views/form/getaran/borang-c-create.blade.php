            ...
            <div class="modal-body m-t-20">
                    ...
                    <div class="col-md-12">
                        <div class="form-group-attached m-b-12">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <input type="hidden" id="gambar_count_getaran" name="gambar_count_getaran" value="1">
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">GAMBAR PERSAMPELAN</b></span></label>
                                        <div class="" id="addGambar">
                                            ...
                                            <button type="button" class="btn btn-info btn-xs" onclick="addGambargetaran()" style="font-size: 12.5px;margin-left:4px;">+</button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="laporan_count_getaran" name="laporan_count_getaran" value="1">

                                    <div class="form-group form-group-default" id="addLaporangetaran">
                                        <label><span><b class="text-dark">LAPORAN KIMIA</b></span></label>
                                        <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file">
                                            <button type="button" class="btn btn-info btn-xs" onclick="addLaporangetaran()" style="font-size: 12.5px;margin-left:4px;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row">
                    <div class="col-md-12" style="overflow:auto; max-height:300px;">
                        <table class="table" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%">
                            <thead>
                                <tr>
...
@include('form.getaran.js.borang-c-create')
<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 8
    };

    $('#stesenGetaranDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.getaran.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.getaran.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.getaran.modal', 'data-id') }}`;
    ...
    $('#stesenGetaranBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('form.getaran.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.getaran.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.getaran.borang-c-create', 'data-id') }}`;

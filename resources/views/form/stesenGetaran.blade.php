...
<div class="row">
    ...
    <div class="col-md-6">
        <span class="float-right">
            ...
            <button type="button" data-action="{{ route('project.tambah.stesen.getaran.modal', $projek) }}?year={{ $year }}&month={{ $month }}" class="btn btn-default btn-xs" onClick="getModalContent(this)">
    ...
    <div class="col-md-12">
        ...
        <div class="card card-transparent">
            <div class="card-block">
                <table class="table" id="stesenGetaranDatatable" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
                    <thead>
    ...
    <div class="col-md-12">
        <div class="card card-transparent">
            <div class="card-block">
                <table class="table" id="stesenGetaranBorangCDatatable" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
                    <thead>
                        <tr style="text-align: center">
                            <th class="fit">Bil.</th>
                            <th>Nama Stesen</th>
...
@include('form/getaran/js/datatable')

<script type="text/javascript">
    let data = {
        jenis_pengawasan_id: 4
    };

    $('#stesenAirTanahDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "render": function(id, type, full, meta) {
                ...
                let viewUrl = `{{ route('project.view.stesen.air.tanah.modal', 'data-id') }}`;
                let editUrl = `{{ route('project.edit.stesen.air.tanah.modal', 'data-id') }}`;
                let deleteUrl = `{{ route('project.delete.stesen.air.tanah.modal', 'data-id') }}`;
    ...
    $('#stesenAirTanahBorangCDatatable').DataTable({
        'serverSide': true,
        'processing': true,
        'ordering': false,
        'searching': false,
        ...
        columnDefs: [
            ...
            "data": 'id',
            "render": function(id, type, full, meta) {
                let viewUrl = `{{ route('form.air.tanah.borang-c-view', 'data-id') }}`;
                // let deleteUrl = `{{ route('project.delete.borangc.air.tanah.modal', 'data-id') }}`;
                let editUrl = `{{ route('form.air.tanah.borang-c-create', 'data-id') }}`;

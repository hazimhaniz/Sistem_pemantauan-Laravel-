<div class="modal fade" id="baseAjaxModalContent" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                    ...
                    <div class="col-md-12">
                        <div class="form-group-attached m-b-12">
                            ...
                            <div class="row">
                                ...
                                @endif
                                <div class="col-md-6">
                                    <input type="hidden" id="gambar_count_airtanah" name="gambar_count_airtanah" value="1">
                                    <div class="form-group form-group-default">
                                        <label><span><b class="text-dark">GAMBAR PERSAMPELAN</b></span></label>
                                        <div class="" id="addGambar">
                                            ...
                                            <button type="button" class="btn btn-info btn-xs" onclick="addGambarairtanah()" style="font-size: 12.5px;">+</button>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <input type="hidden" id="laporan_count_airtanah" name="laporan_count_airtanah" value="1">

                                    <div class="form-group form-group-default" id="addLaporanairtanah">
                                        <label><span><b class="text-dark">LAPORAN KIMIA</b></span></label>
                                        <div tabindex="500" class=""><i class="fa fa-folder-open"></i> <input class="laporan_kimias" name="laporan_kimias[]" type="file">
                                            <button type="button" class="btn btn-info btn-xs" onclick="addLaporanairtanah()" style="font-size: 12.5px;">+</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <table class="table" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%;max-height:300px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center"><input class="form-control" onkeypress="return verifyKey(event)" name="bacaan_ceraps[]" id="{{ $parameter->parameter }}" onkeypress="return verifyKey(event)" autocomplete="off" /></td>
                            </tr>
                            @endforeach
                            @else
                            <?php $i = 1; ?>
                            ...
                            <tr>
                                ...
                                <td class="align-middle text-center"><input class="form-control" name="bacaan_ceraps[]" id="{{ $value->id }}" value="{{ $value->bacaan_cerap }}" autocomplete="off" /></td>
                                @endif
                                @else
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>
                            ...
                            &nbsp;
                            <strong>INDEKS AIR TANAH</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <table class="table table-responsive" id="table" role="grid" aria-describedby="table_info" style="padding:10px; width:100%;max-height:300px;">
                            <thead>
                                <tr>
                                    <th class="align-top text-center" bgcolor="#" style="color:#; width:5%;">INDEKS AIR TANAH</th>
    ...
    @include('form.air-tanah.js.borang-c-create')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group form-group-default">
                                        <div class="form-input-group">
                                            ...
                                            <input disabled id="tarikh_pengsampelan" class="form-control" name="tarikh_pengsampelan" value="{{ $monthlyC->tarikh_pengsampelan ? date('d/m/Y', strtotime($monthlyC->tarikh_pengsampelan)) : '' }}" placeholder="dd/mm/yyyy"  type="text">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">

    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="addModalTitle"> Lihat <b>STESEN AIR TANAH</b></h5>
                @else
                <h5 class="modal-title" id="addModalTitle"> Lihat <b>STESEN AIR TANAH</b></h5>
                @endif                
            ...
            <div class="modal-body m-t-20">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-group required form-group-default">
                                    ...
                                    <input disabled id="stesen" value="{{ $pengawasanAirTanah->stesen }}" name="stesen" class="form-control form-control-lg" type="text" autocomplete="off" />
                                </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="checkbox check-primary">
                                            <input disabled type="checkbox" class="form-check-input" id="airtanah_is_eia" onclick="displayDateEIA()"  checked />
                                            <label class="form-check-label" for="airtanah_is_eia"><font color="red">*</font> Peringkat EIA</label>
                                            @if($pengawasanAirTanah->is_emp)
                                            <input disabled type="checkbox" class="form-check-input" id="airtanah_is_emp" onclick="displayDateEMP()" checked/>
                                            <label class="form-check-label" for="airtanah_is_emp">Peringkat EMP</label>
                                            @else
                                            <input disabled type="checkbox" class="form-check-input" id="airtanah_is_emp" onclick="displayDateEMP()"/>
                                            <label class="form-check-label" for="airtanah_is_emp">Peringkat EMP</label>
                                            @endif
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-group-default input-group" id="show_date_eia" style="display: block;">
                                            <div class="form-input-group">
                                                ...
                                                <input disabled class="form-control datepicker auditData" data-date-end-date="0d" id="airtanah_date_eia" name="airtanah_date_eia" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanAirTanah->date_eia)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-md-12" id="show_date_emp" hidden>
                                            ...
                                            <div class="form-group form-group-default input-group" style="display: block;">
                                                <div class="form-input-group">
                                                    ...
                                                    <input disabled class="form-control datepicker auditData" data-date-end-date="0d" id="airtanah_date_emp" name="airtanah_date_emp" placeholder="dd/mm/yyyy" value="{{ Carbon\Carbon::parse($pengawasanAirTanah->date_emp)->format('d/m/Y') }}" type="text" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-md-12" style="overflow:auto; max-height:300px;">
                                    ...
                                    <table class="table" id="parameterStesenAirTanahTable" role="grid" aria-describedby="table_info" border="1px" style="padding:10px;">
                                        <thead>
                                            <tr role="row">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-center"><input readonly class="form-control base_emp_air" name="base_emp[]" id="base{{ $parameter->id }}" autocomplete="off" value="{{ $parameter->baselineemp }}" /></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
                ...
                <div class="row">
                 ...
                 @if($pengawasanAirTanah->status == 4)
                        @hasanyrole('penyiasat')
                        <div class="modal-footer">
                            <button type="button" class="btn btn-success" onclick="submitStesen({{$pengawasanAirTanah->id}})">Sahkan</button>
                        </div>
                        @endhasanyrole
                        @endif
                @hasanyrole('pp')
                <div class="modal-footer">
                    @if($pengawasanAirTanah->status == 603 || $pengawasanAirTanah->status == 606)
                    <button type="button" data-action="{{ route('project.hantar.stesen', $pengawasanAirTanah) }}" onclick="hantarStesen(this)" class="btn btn-success" data-original-title="Sahkan"><span style="color:#000; font-family: 'Montserrat'; font-size: 10.5px; text-transform: uppercase; font-weight: 500;">&nbsp;Hantar</span></button>
                    @elseif($pengawasanAirTanah->status == 13)
                    <button type="button" data-action="{{ route('project.sahkan.stesen', $pengawasanAirTanah) }}" onclick="hantarStesen(this)" class="btn btn-success" data-original-title="Sahkan"><span style="color:#000; font-family: 'Montserrat'; font-size: 10.5px; text-transform: uppercase; font-weight: 500;">&nbsp;Sahkan</span></button>
                    @endif
                </div>
                @endhasanyrole
            </div>

								...
								<div class="col-lg-12">
									<div class="card card-default">
										<div class="card-header separator">
											<div class="card-title" style="font-weight: bold;font-size: 12.5px">Pendaftaran Pengawasan Sungai</div>
										</div>
										<div class="card-body m-t-20">
											<div class="form-group row control-label col-md-12">
												<label class="col-md-4">Nama Sungai<span style="color:red;">*</span> </label>
												...
												<table class="table table-hover" id="table2">
													...
													<tbody>
														<tr>
															...
															<td>2°10'26.5"E</td>
															<!-- <td>Lorem Ipsum</td>
															<td>02/05/2019 09:00:00</td>
															<td></td>
															<td>
                                                                <a onclick="addData3(3)" href="javascript:;" class="btn btn-primary btn-xs mb-1"><i class="fa fa-search mr-1"></i></a>
                                                            </td> -->
                                                            <td>
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="addModalTitle">Kemaskini <span class="bold">Auditor</span></h5>
...
<div class="modal fade" id="modal-edit3" tabindex="-1" role="dialog" aria-labelledby="addModalTitle" aria-hidden="true">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">

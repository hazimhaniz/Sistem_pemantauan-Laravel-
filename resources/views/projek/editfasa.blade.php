    ...
    <div class="modal-body m-t-20">
        <ul id="tabs-sng" class="nav nav-tabs nav-tabs-blue nav-tabs-fillup d-none d-md-flex d-lg-flex d-xl-flex" role="tablist">
            <li class="nav-item ml-md-3">
                <a class="active" data-toggle="tab" href="#" data-target="#tab1ppedit" role="tab" onclick=""><span>(1) Maklumat Pendaftaran Projek</span></a>
            </li>
            <li class="nav-item">
                <a class="" data-toggle="tab" href="#" data-target="#tab2peedit" role="tab" onclick=""><span>(2)Maklumat Pendaftaran EO & EMC</span></a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane disable" id="tab2peedit">

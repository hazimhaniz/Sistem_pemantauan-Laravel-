	...
	<div class=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
		<div class="inner">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">Pengawasan Udara</li>
			</ol>
			<div class="row">
				<div class="col-xl-12 col-lg-12 ">
					<div class="card card-transparent">
						<div class="card-block p-t-0">
							<h3 class='m-t-0'>Pengawasan Udara</h3>
							<p class="small hint-text m-t-5">
								<p class="hint-text">Maklumat Pengawasan Udara</p>
								...
								<div class="col-lg-12">
									<div class="card card-default">
										<div class="card-header separator">
											<div class="card-title" style="font-weight: bold;font-size: 12.5px">Pendaftaran Pengawasan Udara</div>
										</div>

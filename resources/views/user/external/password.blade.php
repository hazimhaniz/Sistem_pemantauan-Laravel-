    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
            	<form id='form-userpassword' role="form" method="post" action="{{ route('user.external.password.form', request()->id) }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="submitForm('form-userpassword')"> Simpan</button>
            </div>
        </div>
    </div>
</div>

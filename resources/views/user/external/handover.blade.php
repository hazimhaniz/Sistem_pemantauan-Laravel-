    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
            	<form id='form-handover' role="form" method="post" action="{{ route('user.external.handover.form', $user->id) }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="submitForm('form-handover')"><i class="fa fa-check m-r-5"></i> Simpan</button>
            </div>
        </div>
    </div>
</div>

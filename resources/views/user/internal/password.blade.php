    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body m-t-20">
            	<form id='form-userpassword' role="form" method="post" action="{{ route('user.internal.password.form', request()->id) }}">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info" onclick="submitForm('form-userpassword')"><i class="fa fa-check m-r-5"></i> Simpan</button>
            </div>
        </div>
    </div>
</div>

            ...
            <div class="modal-body m-t-20">
                <form id='form-edit' role="form" method="post" action="{{ route('user.internal.form', $user->id) }}">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group form-group-default form-group-default-custom form-group-default-select2 required">
                                <label><span>Bahagian</span></label>
                                <select id="edit_section_id" name="section_id" class="full-width autoscroll state" data-init-plugin="select2" required="">
                                    <option value="" selected="" disabled="">Pilih satu..</option>
...
@if(!empty($user->entity->section_id))
$("#edit_section_id").val( {{ ($user->entity->section_id)?$user->entity->section_id:'-' }} ).trigger('change');
@endif

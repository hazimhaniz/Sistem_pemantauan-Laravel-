    ...
    <div class="container-fluid container-fixed-lg bg-white">
        ...
        <div class="card card-sng" style="background-color:# !important;">
            ...
            <ul id="tabs-sng" class="nav nav-tabs nav-tabs-blue nav-tabs-fillup d-none d-md-flex d-lg-flex d-xl-flex"
                ...
                <li class="nav-item">
                    <a class=p" data-toggle="tab" href="#" data-target="#tab2" role="tab" onclick=""><span>FASA 1</span></a>
                </li>
                <li class="nav-item">
                    <a class=p" data-toggle="tab" href="#" data-target="#tab3" role="tab" onclick=""><span>FASA 2</span></a>
                </li>
                <li class="nav-item">

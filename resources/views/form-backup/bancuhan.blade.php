<div class="row">
    <div class="col-md-12">
        ...
        <table class="" id="table" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
            ...
            <tbody>
                <tr>
                    <td bgcolor="#eefdec">SISA KONKRIT</td>
                    ...
                    <td bgcolor="#f0f0f0" class="align-top text-center"> <div tabindex="500" class="btn btn-primary btn-file"><i

    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <span class="float-right">
                ...
                <a id="form-modal" href="" data-toggle="modal" data-target="#stesenUdara-modal-xl" title=""
            ...
            <!-- Modal -->
            <div class="modal fade" id="stesenUdara-modal-xl" tabindex="-1" role="dialog"
                                            ...
                                            <div class="form-group-attached m-b-10">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group form-group-default">
                                                            <label>
                                                                <span><b class="text-dark">Udara</b></span><span
                                                                    style="color:red;">*</span>
                                                            </label>
                                                            <select id="selectrequired" class="select-normal full-width"
                                                                required="" data-error-msg="Silih pilih cara penerbitan."
            ...
            <table class="" id="table" role="grid" aria-describedby="table_info" border="1px" style="padding:0px;">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="align-top text-center">Udara</td>

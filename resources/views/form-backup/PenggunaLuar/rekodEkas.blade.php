...
@section('content')
                ...
                <table class="table" id="" role="grid" aria-describedby="table_info" border="0px" style="padding:10px;">
                    <thead>
                        <tr role="row">
                            ...
                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:10%; vertical-align:top; color:#fff">Negeri</th>
                            <th bgcolor="#adadad" class="align-top text-center"
                                style="width:10%; vertical-align:top; color:#fff">Status Kemajuan Kerja Projek</th>
                                <th bgcolor="#adadad" class="align-top text-center"
                                style="width:15%; vertical-align:top; color:#fff">Pengawai Jas</th>
                            <th bgcolor="#adadad" class="align-top text-center"
                    ...
                    <tbody>
                        ...
                        $sno =1;
                ?>
                           @foreach($jasfail as $data)
                        <tr>
                            <td class="align-top text-center">{{$sno }}</td>
                            <td class="align-top text-center">{{$data->nofail}}</td>
                            <td class="align-top text-center"> {{$data->name}}</td>
                            <?php
                            $state = App\MasterState::where('id', $data->negeri)->first();
                            $act = App\JasFailDetailAktiviti::where('ekas_id', $data->jas_ekas_id)->first();
                            if ($act){
                             $data->kod = $act->aktiviti;
                             $data->activity = $act->jenis;
                            }
                            ?>
                            <td class="align-top text-center">{{$state->name}}</td>
                            @if ($data->state == 1)
                            <td class="align-top text-center">AKTIF</td>
                            @else
                            <td class="align-top text-center">TIDAK AKTIF</td>
                            @endif
                            <td class="align-top text-center">SUPER ADMIN</td>



                            <td class="align-top text-center">
                                <button type="button" class="dt-button buttons-html5 btn btn-default btn-xs m-t-5"
                                    data-toggle="modal" data-target="#ekas" onclick="passdata({{$data}})">
                                    TINDAKAN
                                </button>
    ...
    <!-- Modal Ahli Projek -->
    <div class="modal fade" id="ekas" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class=" modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalTitle"> KEMASKINI <b>Status Projek</b></h5>
                    ...
                    <div class="form-group-attached m-b-10">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    ...
                                    <input class="form-control form-control-lg" type="text" id="nofail" placeholder="">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group required form-group-default">
                                    <label>
                                        <span><b class="text-dark">Status Kemajuan Kerja Projek</b></span><span style="color:red;">*</span>
                                    </label>
                                    <select
                                    class="select-normal full-width custom-select border border-default" required=""
                                    data-error-msg="Silih pilih butiran perniagaan." id="status">

                                    <option value="1">AKTIF</option>
                                    <option value="0">TIDAK AKTIF</option>
                                    <option value="2">TIADA PENGESAHAN</option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label>
                                        <span><b class="text-dark">KOD AKTIVITI</b></span><span style="color:red;">*</span>
                                    </label>
                                    <input class="form-control form-control-lg" id="kodactivity" type="text" placeholder="">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label>
                                        <span><b class="text-dark"> AKTIVITI</b></span><span style="color:red;">*</span>
                                    </label>
                                    <input class="form-control form-control-lg" type="text" placeholder="" id="activity">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label>
                                        <span><b class="text-dark">AGIHAN TUGAS PENGAWAI PENYIASAT KEPADA</b></span><span style="color:red;">*</span>
                                    </label>
                                    <select id="selectrequired"
                                    class="select-normal full-width custom-select border border-default" required=""
                                    data-error-msg="Silih pilih pengawai.">

                                    <option selected="">Sila Pilih</option>
                                    <option value="">bukhari</option>
                                    <option value="">Farid</option>
                                    <option value="">Aminah</option>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label>
                                        <span><b class="text-dark">AGIHAN TUGAS PENGAWAI PENYELIA KEPADA</b></span><span style="color:red;">*</span>
                                    </label>
                                    <select id="selectrequired"
                                    class="select-normal full-width custom-select border border-default" required=""
                                    data-error-msg="Silih pilih pengawai.">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group form-group-default">
                                    <label>
                                        <span><b class="text-dark">AGIHAN TUGAS PENGAWAI PELULUS KEPADA</b></span><span style="color:red;">*</span>
                                    </label>
                                    <select id="selectrequired"
                                    class="select-normal full-width custom-select border border-default" required=""
                                    data-error-msg="Silih pilih pengawai.">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-info" id="btnSubmit-bayaranfilemmodaladd"
                        onclick="senddata()"></i>Simpan</button>
...
<script type="text/javascript">
    function  passdata(argument) {
        $('#name').val(argument.name)
        $('#id').val(argument.id)
        $('#nofail').val(argument.nofail)
        $('#status').val(argument.status)
        $('#kodactivity').val(argument.kod)
        $('#activity').val(argument.activity)
    }
    function senddata() {
             $.ajax({
            type: "POST",

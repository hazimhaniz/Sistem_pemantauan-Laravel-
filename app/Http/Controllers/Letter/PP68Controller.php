...
class PP68Controller extends Controller
{
    /**
    ...
    public function ap1(Request $request) {
    ...
    public function ap3(Request $request) {
        $letter = Letter::findOrFail($request->id);
        $data_db = $letter->data ? json_decode($letter->data, true) : [];
        $data_uppercase = [];
        $data = [];
        ...
        $data = array_merge($data, [
            ...
            'tagline' => htmlspecialchars(strtoupper(env('JHEKS_TAGLINE', 'BERKHIDMAT UNTUK NEGARA'))),
            'slogan' => htmlspecialchars(env('JHEKS_SLOGAN', 'Pekerja Berkemahiran Penggerak Ekonomi')),
            'pw_name' => htmlspecialchars($letter->entity->province_office->pw->name),
            'province_office_name' => htmlspecialchars($letter->entity->province_office->name),
            // '' => htmlspecialchars(),
        ]);
    ...
    public function ap5(Request $request) {
        $letter = Letter::findOrFail($request->id);
        $data_db = $letter->data ? json_decode($letter->data, true) : [];
        $data_uppercase = [];
        $data = [];
    ...
    public function disapprove(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'pw_name' => htmlspecialchars($letter->entity->province_office->pw->name),
            'province_office_name' => htmlspecialchars($letter->entity->province_office->name),
            'reason_ap3' => htmlspecialchars($letter->filing->justification_fee_approved),
            'reason_ap5' => htmlspecialchars($letter->filing->justification_receipt_approved),
            'reason_ap1' => htmlspecialchars($letter->filing->justification_computer_approved),
            // '' => htmlspecialchars(),
        ]);
    ...
    public function approve_disapprove(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'reason_ap5' => htmlspecialchars($letter->filing->justification_receipt_approved),
            'reason_ap1' => htmlspecialchars($letter->filing->justification_computer_approved),
            'result_ap3' => htmlspecialchars($letter->filing->is_fee_approved ? 'DILULUSKAN' : 'TIDAK DILULUSKAN'),
            'result_ap5' => htmlspecialchars($letter->filing->is_receipt_approved ? 'DILULUSKAN' : 'TIDAK DILULUSKAN'),
            'result_ap1' => htmlspecialchars($letter->filing->is_computer_approved ? 'DILULUSKAN' : 'TIDAK DILULUSKAN'),
            // '' => htmlspecialchars(),
        ]);

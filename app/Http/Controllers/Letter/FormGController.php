...
class FormGController extends Controller
{
    ...
    public function approve(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'registered_at' => htmlspecialchars(date('d/m/Y', strtotime($letter->filing->logs()->where('activity_type_id', 16)->first()->created_at))),
    ...
    public function pnmb(Request $request) {
        ...
        $data = array_merge($data, [
            'reference_no' => $letter->reference ? htmlspecialchars($letter->reference->reference_no) : '',
            // 'entity_name' => htmlspecialchars(optional(optional(optional($letter->filing)->union_history)->old())->union_name),
            'entity_name' => htmlspecialchars(strtoupper($letter->filing->name)),
            'entity_name_uppercase' => htmlspecialchars(strtoupper(optional(optional(optional($letter->filing)->union_history)->old())->union_name)),
            ...
            'district' => $letter->entity->addresses->last()->address->district ? htmlspecialchars($letter->entity->addresses->last()->address->district->name) : '',
            'state' => $letter->entity->addresses->last()->address->state ? htmlspecialchars($letter->entity->addresses->last()->address->state->name) : '',
            'state_uppercase' => $letter->entity->addresses->last()->address->state ? htmlspecialchars(strtoupper($letter->entity->addresses->last()->address->state->name)) : '',

...
class FormPQController extends Controller
{
    ...
    public function approve(Request $request) {
        ...
        $data = array_merge($data, [
            ...
            'address1' => htmlspecialchars($letter->entity->addresses->last()->address->address1),
            'address2' => $letter->entity->addresses->last()->address->address2 ? htmlspecialchars($letter->entity->addresses->last()->address->address2) : '',
            'address3' => $letter->entity->addresses->last()->address->address3 ? htmlspecialchars($letter->entity->addresses->last()->address->address3) : '',

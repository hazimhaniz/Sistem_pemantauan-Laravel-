...
class FormL1Controller extends Controller
{
    /**
    ...
    public function approve(Request $request) {
        ...
        foreach($rows2 as $index => $row2) {
            ...
            $document->setValue('worker_appointed_at#'.($index+1), htmlspecialchars(date('d/m/Y',strtotime($row2->appointed_at))));

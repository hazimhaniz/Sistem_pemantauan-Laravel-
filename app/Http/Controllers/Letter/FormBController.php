...
class FormBController extends Controller
{
    ...
    public function approve(Request $request) {
        ...
        $hqprovince = \App\MasterModel\MasterProvinceOffice::where('id',10)->first();
        ...
        $data = array_merge($data, [
            ...
            'province_office_address' => htmlspecialchars($kpks->province_office->address->address1).
                ...
                ', '.($kpks->province_office->address->postcode).
            ...
            'registered_at' => htmlspecialchars(strftime('%e %B %Y' , strtotime($letter->entity->formb->logs()->where('activity_type_id', 16)->first()->created_at))),

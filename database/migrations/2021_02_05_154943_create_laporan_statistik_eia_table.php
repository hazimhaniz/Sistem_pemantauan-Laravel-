...
class CreateLaporanStatistikEiaTable extends Migration {
	...
	public function up()
	{
		Schema::create('laporan_statistik_eia', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('projek_id')->unsigned()->default(0);
	...
	{
		Schema::drop('laporan_statistik_eia');
	}

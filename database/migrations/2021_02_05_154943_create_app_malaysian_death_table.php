...
class CreateAppMalaysianDeathTable extends Migration {
	...
	public function up()
	{
		Schema::create('app_malaysian_death', function(Blueprint $table)
		{
			...
			$table->string('death_country', 191)->nullable();
			$table->string('death_location', 191)->nullable();
			$table->string('death_cause', 191)->nullable();
			$table->string('death_corpe_manage', 191)->nullable();
			$table->string('death_remark', 191)->nullable();
	...
	{
		Schema::drop('app_malaysian_death');
	}
